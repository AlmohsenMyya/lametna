...
import 'package:lametna/controllers/chat/room%20managment/roles/rolesController.dart';
import '../../appBar.dart';
...
class RolesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: appbarBuilder("إضافة حساب", true, color: color),
      body: ListView(
        children: [
          SizedBox(
            height: 14.h,
  ...
  Widget accessBuilder(int index, RolesController controller) {
