...
import 'package:lametna/controllers/customer%20service/complaintsSuggestionsController.dart';
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: GetBuilder<ComplaintsSuggestionsController>(
              init: ComplaintsSuggestionsController(),
              builder: (controller) {
