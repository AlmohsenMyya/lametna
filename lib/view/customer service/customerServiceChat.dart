...
import 'package:lametna/controllers/customer%20service/customerServicesController.dart';
...
class CustomerServiceChat extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appbarBuilder("خدمة العملاء", false),
      body: Column(
        children: [
          // Expanded(child: Placeholder()),
          Expanded(
            child: GetBuilder<CustomerServicesController>(
              init: CustomerServicesController(),
              builder: (controller) {
          ...
          SizedBox(
            ...
            // color: Colors.amber,
            child:
                GetBuilder<CustomerServicesController>(builder: (controller) {
              return Row(
                children: [
                  GestureDetector(
                    onTap: () {
